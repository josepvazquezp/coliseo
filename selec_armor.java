...
public class selec_armor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					selec_armor frame = new selec_armor();
	...
	public selec_armor() {
		...
		breastplate.setIcon(new ImageIcon(selec_armor.class.getResource("/coliseo/images/breastplate_c.png")));
		...
		helmet.setIcon(new ImageIcon(selec_armor.class.getResource("/coliseo/images/helmet_c.png")));
		...
		fondo.setIcon(new ImageIcon(selec_armor.class.getResource("/coliseo/images/fondo_weaponsB.jpg")));
